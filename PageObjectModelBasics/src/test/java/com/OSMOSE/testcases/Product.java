...
public class Product extends BaseTest{
    ...
    @Test(dataProviderClass = Utilities.class,dataProvider ="dp",description = "Verify that User clicks on the Slider icon",enabled = false)
    ...
    public void VerifyAddButtonEnabled() throws InterruptedException {
        ...
        pp.clickOnProductImage();
        pp.AddQuantityInCart_AssertCellNumber();
        Assert.assertTrue(Page.isElementPresent(By.xpath("//*[contains(text(),'ADD')]")));
    }
