package com.OSMOSE.utilities;
public class TestConfig{


	
	public static String server="smtp.gmail.com";
	public static String from = "rajeshyadav8@gmail.com";
	public static String password = "Password@123456789";
	public static String[] to ={"rajeshyadav8@gmail.com","rajesh.yadav@centurylink.com"};
